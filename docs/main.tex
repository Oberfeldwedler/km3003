...
Für die Anbindung einer MySQL Datenbank gibt es verschiedene Optionen welche verwendet werden können, die sich aber für diesen Anwendungsfall nur geringfügig unterscheiden. Der von Oracle selbst entwickelte MySQL Python Connector und PyMySQL sind beide PEP249 kompatibel, sodass sich deren API meist nur im Namen der Methoden unterscheiden. In disem Projekt wurde PyMySQL verwendet, da ich Community-Lösungen gegenüber Angeboten von kommerziellen Anbietern bevorzuge. \cite{PyMySQLPurePython} \cite{MysqlconnectorpythonSelfcontainedPython}

\subsection{Datenbankstruktur}
Bei der Konzeption der Datenbank wurde speziell darauf geachtet, Redundanzen und Inkonsistenzen durch die Struktur der Datenbank zu verhindern. Jede Logik welche direkt durch die Struktur der Datenbank abgebildet werden kann wurde in die Datenbank zu verlagert.
So 

Die Datenbank besteht aus den Tabellen users, products, purchases und deposits. 
\cite{NormalisierungDatenbank2024}
