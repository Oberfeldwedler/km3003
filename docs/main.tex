...
Im Allgemeinen sind Datenbankanfragen immer nach dem gleichen Schema implementiert. Der Rohbau einer Query steht direkt im Code als String. Variable Elemnte der Abfragen werden vorerst durch Platzhalter repräsentiert. Die Funktion \codeword{execute(query, args)} baut dann aus dem Rohbau der Query und einem Tupel  mit den einzusetzenden Werten die fertige Query und führt sie aus.
